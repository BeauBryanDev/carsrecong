...
# 1. Import your declarative Base and ALL your models here
# This is mandatory for Alembic's --autogenerate feature to detect your tables
...
# 2. Set the target metadata for autogenerate
target_metadata = Base.metadata

# 3. Dynamically build the Database URL from Environment Variables
POSTGRES_USER = os.getenv("POSTGRES_USER", "admin")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", "secretpassword")
POSTGRES_HOST = os.getenv("POSTGRES_HOST", "db")
POSTGRES_DB = os.getenv("POSTGRES_DB", "cars_db")
